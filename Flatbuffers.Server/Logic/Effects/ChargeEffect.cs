...
public class ChargeEffect : StaticEffect, IGameEffect
{
	...
	public override void Start(GameLiving living)
	{
		...
		foreach (GamePlayer t_player in living.GetPlayersInRadius(WorldManager.VISIBILITY_DISTANCE))
		{
			t_player.Out.SendSpellEffectAnimation(living, living, 7035, 0, false, 1);
		}

		living.LastAttackedTick = m_startTick;
		...
		m_living.BuffBonusMultCategory.Set((int)eProperty.MaxSpeed, this, PropertyCalc.MaxSpeedCalculator.SPEED3);
	...
	public override void Cancel(bool playerCancel)
	{
		...
		m_living.BuffBonusMultCategory.Remove((int)eProperty.MaxSpeed, this);
		//Send messages
		if (m_living is GamePlayer)
		{
	...
	{
		StopTimers();
		m_expireTimer = new RegionTimer(m_living, new RegionTimerCallback(ExpiredCallback), DURATION * 1000);
	}
