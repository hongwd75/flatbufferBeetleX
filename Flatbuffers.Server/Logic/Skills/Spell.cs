...
namespace Game.Logic.Skills
{
	public class Spell : Skill, ICustomParamsValuable
	{
		...
		public bool IsBuff
		{
			get { return (IsHelpful && (Duration > 0 || Concentration > 0)); }
		}
			...
			: base(dbspell.Name, dbspell.SpellID, (ushort)dbspell.Icon, requiredLevel, dbspell.TooltipId)
		{
			...
			// Params
			this.InitFromCollection<DBSpellXCustomValues>(dbspell.CustomValues, param => param.KeyName,
				param => param.Value);
		}
		...
		{
			get { return InstrumentRequirement != 0; }
		}
		...
		{
			get { return SubSpellID > 0 || MultipleSubSpells.Count > 0; }
		}
		...
		{
			get { return Frequency > 0 && !IsPulsing; }
		}
		...
		{
			get { return this.GetParamValue<ushort>("InternalIconID"); }
		}

		public IList<int> MultipleSubSpells
		{
			get { return this.GetParamValues<int>("MultipleSubSpellID").Where(id => id > 0).ToList(); }
		}

		public bool AllowCoexisting
		{
			get { return this.GetParamValue<bool>("AllowCoexisting"); }
		}
