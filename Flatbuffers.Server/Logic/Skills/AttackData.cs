...
public class AttackData
{
    ...
    public bool IsRandomFumble => (IsMeleeAttack) ? RandomUtil.Chance(Attacker.ChanceToFumble) : false;
    public bool IsRandomMiss => (IsMeleeAttack) ? RandomUtil.Chance(Target.ChanceToBeMissed) : false;
