	...
	public static class CustomParamsExtensions
	{
		...
		private static void ReplaceEntry(this ICustomParamsValuable obj, string key, List<string> val)
		{
			obj.CustomParamsDictionary =
				obj.CustomParamsDictionary
					.Select(kv => kv.Key == key ? new KeyValuePair<string, List<string>>(key, val) : kv)
		...
		public static void InitFromCollection<T>(this ICustomParamsValuable obj, IEnumerable<T> collection,
