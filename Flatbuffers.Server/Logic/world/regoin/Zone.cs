...
using log4net;
using DictionaryEntry = Game.Logic.Collections.DictionaryEntry;
...
public class Zone : ITranslatableObject
	{
        ...
        internal ArrayList GetObjectsInRadius(eGameObjectType type, Coordinate coordinate, ushort radius, ArrayList partialList, bool ignoreZ)
		{
			...
			Game.Logic.Collections.Hashtable inZoneElements = new Game.Logic.Collections.Hashtable();
			Game.Logic.Collections.Hashtable outOfZoneElements = new Game.Logic.Collections.Hashtable();
		...
		private void UnsafeAddToListWithoutDistanceCheck(SubNodeElement startElement, int typeIndex, int subZoneIndex, ArrayList partialList, Game.Logic.Collections.Hashtable inZoneElements, Game.Logic.Collections.Hashtable outOfZoneElements)
		{
		...
		private void UnsafeAddToListWithDistanceCheck(
			...
			Game.Logic.Collections.Hashtable inZoneElements,
			Game.Logic.Collections.Hashtable outOfZoneElements,
			bool ignoreZ)
		{
		...
		private bool ShouldElementMove(SubNodeElement currentElement, int typeIndex, int subZoneIndex, Game.Logic.Collections.Hashtable inZoneElements, Game.Logic.Collections.Hashtable outOfZoneElements)
		{
		...
		private void PlaceElementsInZone(Game.Logic.Collections.Hashtable elements)
		{
		...
		private void PlaceElementsInOtherZones(Game.Logic.Collections.Hashtable elements)
		{
			DictionaryEntry currentEntry = null;
		...
		public List<GameNPC> GetNPCsOfZone(eRealm[] realms, int minLevel, int maxLevel, int compareLevel, int conLevel, bool firstOnly)
		{
			...
			try
			{
				...
				int currentSubZoneIndex = RandomUtil.Int(SUBZONE_NBR);
