...
namespace Game.Logic.Geometry
{
    public struct Position
    {
        ...
        public Region Region => WorldManager.GetRegion(RegionID);
        ...
        public static Position Create(ushort regionID, int x, int y, int z, ushort heading)
            => new()
            {
                RegionID = regionID, Coordinate = Coordinate.Create(x, y, z), Orientation = Angle.Heading(heading)
            };

        public static Position Create(ushort regionID, int x = 0, int y = 0, int z = 0, Angle? orientation = null)
            => new()
            {
                RegionID = regionID, Coordinate = Coordinate.Create(x, y, z), Orientation = orientation ?? Angle.Zero
            };
        ...
        public static Position CreateInZone(ushort zoneID, int x = 0, int y = 0, int z = 0, ushort heading = 0)
        {
            ...
            return new()
            {
                ...
                Orientation = Angle.Heading(heading)
            };
        }
        ...
        public Position With(ushort? regionID = null, int? x = null, int? y = null, int? z = null,
            ushort? heading = null)
        {
