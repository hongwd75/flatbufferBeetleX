...
namespace Game.Logic.Events
{
	...
	{
		private static GameEventManager soleInstance = new GameEventManager();
		...
		/// </summary>
		protected static Dictionary<object, GameEventHandlerCollection> m_gameObjectEventCollections;
		...
		public static int NumObjectHandlers
		{
			...
			{
				int numHandlers = 0;
				Dictionary<object, GameEventHandlerCollection> cloneGameObjectEventCollections = new Dictionary<object,GameEventHandlerCollection>(m_gameObjectEventCollections);

				foreach (GameEventHandlerCollection handler in cloneGameObjectEventCollections.Values)
				{
		...
		private readonly GameEventHandlerCollection m_globalHandlerCollection;

		public static GameEventHandlerCollection GlobalHandlerCollection => soleInstance.m_globalHandlerCollection;
		...
		protected GameEventManager()
		{
			...
			m_gameObjectEventCollections = new Dictionary<object, GameEventHandlerCollection>();
			m_globalHandlerCollection = new GameEventHandlerCollection();
		}
		...
		public static void RegisterGlobalEvents(Assembly asm, Type attribute, GameEvent e)
		{
			if(asm == null)
			...
			foreach(Type type in asm.GetTypes())
			{
				...
				foreach(MethodInfo mInfo in type.GetMethods(BindingFlags.Public | BindingFlags.Static))
				{
					...
					if(myAttribs.Length != 0)
					{
						try
						{
							GlobalHandlerCollection.AddHandler(e, (GameEventHandler) Delegate.CreateDelegate(typeof(GameEventHandler), mInfo));
						}
						catch(Exception ex)
						{
		...
		/// <exception cref="ArgumentNullException">If one of the parameters is null</exception>
		public static void AddHandler(GameEvent e, GameEventHandler del)
		{
		...
		/// <param name="del">The event handler to register for this event type</param>
		/// <exception cref="ArgumentNullException">If one of the parameters is null</exception>
		public static void AddHandlerUnique(GameEvent e, GameEventHandler del)
		{
		...
		/// <param name="del">The event handler to register for this event type</param>
		/// <exception cref="ArgumentNullException">If one of the parameters is null</exception>
		public static void AddHandlerUnique(object obj, GameEvent e, GameEventHandler del)
		{
		...
		/// <exception cref="ArgumentNullException">If one of the parameters is null</exception>
		private static void AddHandler(GameEvent e, GameEventHandler del, bool unique)
		{
			if(e == null)
				throw new ArgumentNullException("e", "No event type given!");
		...
		/// <param name="del">The event handler to register for this event type</param>
		/// <exception cref="ArgumentNullException">If one of the parameters is null</exception>
		public static void AddHandler(object obj, GameEvent e, GameEventHandler del)
		{
		...
		/// <param name="unique">Flag wether event shall be added unique or not</param>
		/// <exception cref="ArgumentNullException">If one of the parameters is null</exception>
		private static void AddHandler(object obj, GameEvent e, GameEventHandler del, bool unique)
		{
			if(obj == null)
			...
			if(Lock.TryEnterUpgradeableReadLock(LOCK_TIMEOUT))
			{
				try
				{
					GameEventHandlerCollection col;

					if(!m_gameObjectEventCollections.TryGetValue(obj, out col))
					{
						col = new GameEventHandlerCollection();
		...
		/// <exception cref="ArgumentNullException">If one of the parameters is null</exception>
		public static void RemoveHandler(GameEvent e, GameEventHandler del)
		{
			if(e == null)
				throw new ArgumentNullException("e", "No event type given!");
		...
		/// <param name="del">The event handler to deregister for this event type</param>
		/// <exception cref="ArgumentNullException">If one of the parameters is null</exception>
		public static void RemoveHandler(object obj, GameEvent e, GameEventHandler del)
		{
			if(obj == null)
				throw new ArgumentNullException("obj", "No object given!");
			...
			GameEventHandlerCollection col = null;
		...
		public static void Notify(GameEvent e)
		{
			Notify(e, null, null);
		}
		...
		/// <exception cref="ArgumentNullException">If no event type given</exception>
		public static void Notify(GameEvent e, object sender)
		{
		...
		/// <exception cref="ArgumentNullException">If no event type given</exception>
		public static void Notify(GameEvent e, EventArgs args)
		{
			Notify(e, null, args);
		}
		...
		public static void Notify(GameEvent e, object sender, EventArgs eArgs)
		{
			if(e == null)
				throw new ArgumentNullException("e", "No event type given!");
