...
public class GameInventoryItem : InventoryItem, IGameInventoryItem, ITranslatableObject
	{
		...
		public virtual void Delve(List<String> delve, GamePlayer player)
		{
			...
			if (IsCrafted)
			{
				delve.Add(LanguageMgr.GetTranslation(player.Network.Account.Language, "DetailDisplayHandler.HandlePacket.CrafterName", Creator));
				delve.Add(" ");
			}
			...
			{
				WriteUsableClasses(delve, player.Network);
				WriteMagicalBonuses(delve, player.Network, false);
			...
			if (Object_Type == (int)eObjectType.Shield)
			{
				WriteUsableClasses(delve, player.Network);
				WriteMagicalBonuses(delve, player.Network, false);
				DelveShieldStats(delve, player.Network);
			}
			...
			if (!IsPickable)
				delve.Add(LanguageMgr.GetTranslation(player.Network.Account.Language, "DetailDisplayHandler.HandlePacket.CannotTraded"));

			if (!IsDropable)
				delve.Add(LanguageMgr.GetTranslation(player.Network.Account.Language, "DetailDisplayHandler.HandlePacket.CannotSold"));

			if (IsIndestructible)
				delve.Add(LanguageMgr.GetTranslation(player.Network.Account.Language, "DetailDisplayHandler.HandlePacket.CannotDestroyed"));

			if (BonusLevel > 0)
			{
				delve.Add(" ");
				delve.Add(LanguageMgr.GetTranslation(player.Network.Account.Language, "DetailDisplayHandler.HandlePacket.BonusLevel", BonusLevel));
			}

			//Add admin info
			if (player.Network.Account.PrivLevel > 1)
			{
                WriteTechnicalInfo(delve, player.Network);
			}
		}
		...
		protected virtual void DelveWeaponStats(List<String> delve, GamePlayer player)
		{
			...
			delve.Add(" ");
			delve.Add(LanguageMgr.GetTranslation(player.Network.Account.Language, "DetailDisplayHandler.WriteClassicWeaponInfos.DamageMod"));

			if (itemDPS != 0)
			{
				delve.Add(LanguageMgr.GetTranslation(player.Network.Account.Language, "DetailDisplayHandler.WriteClassicWeaponInfos.BaseDPS", itemDPS.ToString("0.0")));
				delve.Add(LanguageMgr.GetTranslation(player.Network.Account.Language, "DetailDisplayHandler.WriteClassicWeaponInfos.ClampDPS", clampedDPS.ToString("0.0")));
			}

			if (SPD_ABS >= 0)
			{
				delve.Add(LanguageMgr.GetTranslation(player.Network.Account.Language, "DetailDisplayHandler.WriteClassicWeaponInfos.SPD", itemSPD.ToString("0.0")));
			}

			if (Quality != 0)
			{
				delve.Add(LanguageMgr.GetTranslation(player.Network.Account.Language, "DetailDisplayHandler.WriteClassicWeaponInfos.Quality", Quality));
			}

			if (Condition != 0)
			{
				delve.Add(LanguageMgr.GetTranslation(player.Network.Account.Language, "DetailDisplayHandler.WriteClassicWeaponInfos.Condition", ConditionPercent));
			}

			delve.Add(LanguageMgr.GetTranslation(player.Network.Account.Language,
			...
			delve.Add(LanguageMgr.GetTranslation(player.Network.Account.Language, "DetailDisplayHandler.WriteClassicWeaponInfos.EffDamage"));
		...
		{
			delve.Add(LanguageMgr.GetTranslation(player.Network.Account.Language, "DetailDisplayHandler.WriteClassicArmorInfos.ArmorMod"));
			...
			if (DPS_AF != 0)
			{
				delve.Add(LanguageMgr.GetTranslation(player.Network.Account.Language, "DetailDisplayHandler.WriteClassicArmorInfos.BaseFactor", DPS_AF));
				...
				delve.Add(LanguageMgr.GetTranslation(player.Network.Account.Language, "DetailDisplayHandler.WriteClassicArmorInfos.ClampFact", (int)af));
			}

			if (SPD_ABS >= 0)
			{
				delve.Add(LanguageMgr.GetTranslation(player.Network.Account.Language, "DetailDisplayHandler.WriteClassicArmorInfos.Absorption", SPD_ABS));
			}

			if (Quality != 0)
			{
				delve.Add(LanguageMgr.GetTranslation(player.Network.Account.Language, "DetailDisplayHandler.WriteClassicArmorInfos.Quality", Quality));
			}

			if (Condition != 0)
			{
				delve.Add(LanguageMgr.GetTranslation(player.Network.Account.Language, "DetailDisplayHandler.WriteClassicArmorInfos.Condition", ConditionPercent));
			}

			delve.Add(" ");
			delve.Add(LanguageMgr.GetTranslation(player.Network.Account.Language, "DetailDisplayHandler.WriteClassicArmorInfos.EffArmor"));

			if (DPS_AF != 0)
			{
				effectiveAF = af * Quality / 100.0 * Condition / MaxCondition * (1 + SPD_ABS / 100.0);
				delve.Add(LanguageMgr.GetTranslation(player.Network.Account.Language, "DetailDisplayHandler.WriteClassicArmorInfos.Factor", (int)effectiveAF));
			}
		}
		...
		public virtual void WriteTechnicalInfo(List<String> delve, GameClient client)
		{
			...
			delve.Add("");
            delve.Add("   Value/Price: " + Money.GetShortString(Price) + " / " + Money.GetShortString((long)(Price * (long)Properties.ITEM_SELL_RATIO * .01)));
