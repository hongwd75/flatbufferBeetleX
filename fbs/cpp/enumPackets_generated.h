...
enum ServerPackets : uint16_t {
  ...
  ServerPackets_SC_CharacterStatusUpdate = 5,
  ServerPackets_SC_PlayerCreate = 6,
  ServerPackets_SC_MovingObjectCreate = 7,
  ServerPackets_SC_NPCCreate = 8,
  ServerPackets_SC_ObjectCreate = 9,
  ServerPackets_SC_ModelChange = 10,
  ServerPackets_SC_RemoveObject = 11,
  ServerPackets_SC_ConcentrationList = 12,
  ServerPackets_SC_CombatAnimation = 13,
  ServerPackets_SC_SpellCastAnimation = 14,
  ServerPackets_SC_SpellEffectAnimation = 15,
  ServerPackets_SC_EmoteAnimation = 16,
  ServerPackets_SC_StringMessage = 17,
  ServerPackets_SC_DialogBoxMessage = 18,
  ServerPackets_SC_MaxSpeed = 19,
  ServerPackets_SC_Quit = 20,
  ServerPackets_MIN = ServerPackets_SC_LoginAns,
  ServerPackets_MAX = ServerPackets_SC_Quit
};

inline const ServerPackets (&EnumValuesServerPackets())[20] {
