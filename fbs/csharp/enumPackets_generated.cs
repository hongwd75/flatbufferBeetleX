...
public enum ServerPackets : ushort
{
  ...
  SC_PlayerCreate = 12,
  SC_MovingObjectCreate = 13,
  SC_NPCCreate = 14,
  SC_ObjectCreate = 15,
  SC_ModelChange = 16,
  SC_RemoveObject = 17,
  SC_ConcentrationList = 18,
  SC_CombatAnimation = 19,
  SC_SpellCastAnimation = 20,
  SC_SpellEffectAnimation = 21,
  SC_EmoteAnimation = 22,
  SC_StringMessage = 23,
  SC_DialogBoxMessage = 24,
  SC_MaxSpeed = 25,
  SC_Quit = 26,
};
